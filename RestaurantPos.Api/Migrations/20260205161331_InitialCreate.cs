...
namespace RestaurantPos.Api.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "IngredientStockAdjustments",
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IngredientStockAdjustments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_IngredientStockAdjustments_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_IngredientStockAdjustments_Ingredients_IngredientId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IngredientStockAdjustments_IngredientId",
                table: "IngredientStockAdjustments",
                column: "IngredientId");

            migrationBuilder.CreateIndex(
                name: "IX_IngredientStockAdjustments_UserId",
                table: "IngredientStockAdjustments",
                column: "UserId");
